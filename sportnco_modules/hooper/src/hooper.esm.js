...
function renderIndicator(h, index, isCurrent, onClick, ariaLabelButton) {
...
function renderDefault(h, current, totalCount, slideToIndex, ariaLabelButton) {
  var children = [];
...
var Pagination = {
  ...
  render: function render(h) {
    ...
    }, _this.$hooper.settings.ariaLabelButton) : renderFraction(h, this.currentSlide, totalCount);
    return h('div', {
      class: {
